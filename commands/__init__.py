...
__custom_commands__ = [
    ...
    OBDCommand('GFORCE_AND_YAW',    'G-Force, Yaw and Steering Angle',  b'2147', 5, gforce_and_yaw,     ECU.ALL, True, b'7B0'),
    OBDCommand('STATE_OF_CHARGE',   'State of charge',                  b'015B', 1, state_of_charge,    ECU.ALL, True, b'7E2'),
]
